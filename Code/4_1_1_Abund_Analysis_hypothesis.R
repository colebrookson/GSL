...
for(i in which(fishInvert == "invertebrate")){
  # Build data
...
energyWAICBottomSurface <- energyWAIC[,1]
saveRDS(energyWAICBottomSurface, file = "energyWAICBottomSurface.RDS")

write.csv(energyWAIC, file = "energyWAIC_Bottom.csv")
